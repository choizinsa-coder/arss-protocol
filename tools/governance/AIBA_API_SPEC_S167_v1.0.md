...
**작성일**: 2026-05-29 (KST)  
**작성자**: Caddy  
**상태**: COMPLETE — API Specification 완성  
**범위 확정**: 비오(Joshua) S167 — API 명세(Endpoint/Method/Schema/Auth/State Model/Permission Boundary)로 한정  
**변경 이력**: v0.1→v0.2 미확인 4건 보완 / v0.2→v1.0 상태 확정 + Known Infrastructure Gaps 분리
...
12. [Known Infrastructure Gaps](#12-known-infrastructure-gaps)
...
*AIBA_API_SPEC_S167_v1.0.md — Caddy S167*
